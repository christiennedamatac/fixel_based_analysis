...
## pip install TractSeg pip
# how to pip install https://github.com/MIC-DKFZ/TractSeg/archive/master.zip
...
qsub -N TOM_tracking -V -l walltime=12:00:00,mem=20gb
...
for tract in SLF_I_II_III_left;do
...
# view fixel map of right cingulum by opening index file of fdc_smooth (or other metric) in fixel plot overlay , threshold by CG_right.mif >0.95
# use CG_right.mif as ROI mask for fixelcfestats
